...
// import { markFirstDialogueJoined, markFirstMessageSent } from '@/lib/onboarding/page'
...
export default function DialogueRoomPage() {
  ...
  try {
    ...
    try {
      const { sendNewMessageEmail } = await import('@/lib/email/email')
      ...
      console.error('Email import failed:', emailErr)
    }
