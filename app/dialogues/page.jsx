...
export default function DialoguesPage() {
  ...
  // Create dialogue view - Responsive
  if (showCreate) {
    return (
      <div className="min-h-screen bg-slate-950">
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4 mb-6 sm:mb-8 animate-fadeUp">
          <div>
            ...
            {dialogues.map((dialogue, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Participant tags - Scrollable on mobile if many */}
