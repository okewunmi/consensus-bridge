...
//       const isParticipant = s.dialogues?.dialogue_participants?.some(
//         (p) => p.user_id === user.id,
//       );
...
//             <p className="text-slate-400">
//               No syntheses to review yet. Participate in dialogues to generate
//               consensus.
//             </p>
//           </Card>
//         ) : (
...
//               const participants =
//                 synthesis.dialogues?.dialogue_participants || [];
...
//                 totalVerified > 0
//                   ? Math.round(
//                       (verifications.filter((v) => v.decision === "approve")
//                         .length /
//                         totalVerified) *
//                         100,
//                     )
...
//                         {needsReview && (
//                           <Tag color="amber">Needs Your Review</Tag>
//                         )}
//                         {synthesis.approved && (
...
//                       style={{
//                         width: `${(totalVerified / totalParticipants) * 100}%`,
//                       }}
//                     />
//                   </div>
//                 </Card>
